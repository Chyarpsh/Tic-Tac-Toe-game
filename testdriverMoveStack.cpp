...
// This is the driver function of class MoveStack which performs push,pop operations of implemented stack
// Also gets the size of the stack and topmost element of the stack.
